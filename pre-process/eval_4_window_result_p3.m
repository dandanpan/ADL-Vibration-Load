...
load('eval_table_p3.mat');
SensorResults{1,1} = Result;

load('eval_floor_p3.mat');
SensorResults{2,1} = Result;

load('eval_current_p3.mat');
...
for sensorID = 1:3
    ...
    for setID = 1:totalSetNum
        ...
        load(['/Users/shijiapan/Box Sync/Activity_Detection/0408/PortLab_20190408_Route_P3_Rep' num2str(repID{1}(setID)) '.mat']);
...
save('eval_p_p3.mat','SensorResults');
return;
