...
for windowID = 1:5
    ...
    save(['eval_table_window' num2str(windowID) '.mat'],'Results');
end
%% Floor
clear all
close all
...
for windowID = 1:5
    ...
    save(['eval_floor_window' num2str(windowID) '.mat'],'Results');
end
%% Current
clear all
close all
...
for windowID = 1:5
    ...
    save(['eval_current_window' num2str(windowID) '.mat'],'Results');
end