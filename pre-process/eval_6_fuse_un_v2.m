...
%         result_ours{eventID} = [result_ours{eventID},sum(estimation2{repID}(eIdx)==SensorResults{1, repID}.ObservLabelTest(eIdx))./length(SensorResults{1, repID}.ObservLabelTest(eIdx))];
        ...
        result_v2{eventID} = [result_v2{eventID},sum(estimation_cf{repID}(eIdx)==gt1{repID}(eIdx))./length(gt1{repID}(eIdx))];
...
total = [mean(finalResult_same(:,1)),mean(finalResult_p4(~isnan(finalResult_p4(:,1)),1)),mean(finalResult_p3(~isnan(finalResult_p3(:,1)),1)),mean(finalResult_p5(:,1));...
        mean(finalResult_same(:,2)),mean(finalResult_p4(~isnan(finalResult_p4(:,2)),2)),mean(finalResult_p3(~isnan(finalResult_p3(:,2)),2)),mean(finalResult_p5(:,2));...
        mean(finalResult_same(:,3)),mean(finalResult_p4(~isnan(finalResult_p4(:,3)),3)),mean(finalResult_p3(~isnan(finalResult_p3(:,3)),3)),mean(finalResult_p5(:,3));...
        mean(finalResult_same(:,4)),mean(finalResult_p4(~isnan(finalResult_p4(:,4)),4)),mean(finalResult_p3(~isnan(finalResult_p3(:,4)),4)),mean(finalResult_p5(:,4));...
        mean(finalResult_same(:,5)),mean(finalResult_p4(~isnan(finalResult_p4(:,5)),5)),mean(finalResult_p3(~isnan(finalResult_p3(:,5)),5)),mean(finalResult_p5(:,5))];
figure;
bar(total');
ylim([0,1]);
