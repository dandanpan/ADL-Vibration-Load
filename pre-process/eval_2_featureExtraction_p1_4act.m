...
save('feature_table_p1_4act.mat','FeatureSet');
...
save('feature_floor_p1_4act.mat','FeatureSet');
...
for repID = validRep
    ...
    for eventID = 1:length(Currents{repID}.stepStartIdxArray)
        ...
        tempSig3 = data(5,Currents{repID}.stepStartIdxArray(eventID):Currents{repID}.stepStopIdxArray(eventID));
        tempSig3 = signalNormalization(tempSig3);
        tempFea3 = frequencyFeature( tempSig3, Fs, 0, 10 );
...
%         FeatureSet{repID}.Feature = [FeatureSet{repID}.Feature; tempFea(1:200,2)', tempSigStd]; %
        ...
        FeatureSet{repID}.Feature3 = [FeatureSet{repID}.Feature3; tempFea3(1:200,2)'];

        FeatureSet{repID}.Label = [FeatureSet{repID}.Label; the_label];      
    end
end
save('feature_current_p1_4act.mat','FeatureSet');
