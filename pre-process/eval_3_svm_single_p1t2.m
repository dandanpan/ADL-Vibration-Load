...
for testingSet = [1,2,6,7,8]
    ...
    Results{resultCount}.predicted_label = predicted_label;
    Results{resultCount}.accuracy = accuracy;
    Results{resultCount}.decision_values = decision_values;
    Results{resultCount}.predicted_label2 = predicted_label2;
    Results{resultCount}.accuracy2 = accuracy2;
    Results{resultCount}.decision_values2 = decision_values2;
    Results{resultCount}.predicted_label3 = predicted_label3;
    Results{resultCount}.accuracy3 = accuracy3;
    Results{resultCount}.decision_values3 = decision_values3;
    Results{resultCount}.label = testLabel;
    ...
    Results{resultCount}.cMatrix = cMatrix;
    Results{resultCount}.cMatrix2 = cMatrix2;
    Results{resultCount}.cMatrix3 = cMatrix3;
end

save('eval_table_4act.mat','Results');
save('feature_table_4act.mat','FeatureSet');
...
save('eval_floor_4act.mat','Results');
save('feature_floor_4act.mat','FeatureSet');
...
save('eval_current_4act.mat','Results');
save('feature_current_4act.mat','FeatureSet');
