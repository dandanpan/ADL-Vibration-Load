...
for sensorID = 1:3
    ...
    if sensorID == 1
        ...
        load('feature_table_p3.mat');
        TFeature = [TFeature, FeatureSet];
        load('feature_table_p4.mat');
        TFeature = [TFeature, FeatureSet([2:5,9])];
    elseif sensorID == 2
        load('feature_floor_p5.mat');
        TFeature = FeatureSet([3,4,5,9,10]);
        load('feature_floor_p3.mat');
        TFeature = [TFeature, FeatureSet];
        load('feature_floor_p4.mat');
        TFeature = [TFeature, FeatureSet([2:5,9])];
    elseif sensorID == 3
        load('feature_current_p5.mat');
        TFeature = FeatureSet([3,4,5,9,10]);
        load('feature_current_p3.mat');
        TFeature = [TFeature, FeatureSet];
        load('feature_current_p4.mat');
        TFeature = [TFeature, FeatureSet([2:5,9])];
    end
    ...
    if sensorID == 1
        save('eval_table_un.mat','Result');
    elseif sensorID == 2
        save('eval_floor_un.mat','Result');
    elseif sensorID == 3
        save('eval_current_un.mat','Result');
    end
