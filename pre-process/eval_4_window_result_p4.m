...
load('eval_table_p4.mat');
SensorResults{1,1} = Result;

load('eval_floor_p4.mat');
SensorResults{2,1} = Result;

load('eval_current_p4.mat');
...
for sensorID = 1:3
    ...
    for setID = 1:totalSetNum
        load(['/Users/shijiapan/Box Sync/Activity_Detection/0429/PortLab_20190429_Route_P4_Rep' num2str(repID{1}(setID)) '.mat']);
...
save('eval_p_p4.mat','SensorResults');
return;
